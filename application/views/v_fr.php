		            		...
		            		<form class="mdl-formulario disabled text-left">
		        				...
		        				<div class="col-xs-12 mdl-label m-t-10">
		    						<label class="mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect" for="checkbox-1">
										...
										<span class="mdl-checkbox__label f-s-14" style="">J'ai lu et accepte les <a class="FONDO_TERMINOS" href="http://www.sap-latam.com/sap_business_one/public/pdf/SAP_Marketing_Configurator_Portals_Privacy_Policy.pdf" target="_blank">termes et conditions SAP</a></span>
									</label>
		        				</div>
